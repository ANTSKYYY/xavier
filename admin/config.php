...
$auth_users = array(
    'admin' => '$2y$10$Pwi5FwLbuQIR6lcWcHcPC.Oq6No3br.YAZrao8xcdM/my2ZE2w6Eu', //admin@123
);
...
$root_path = '/var/www/xavierlegall.holo-food.store/utils/upload';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/utils/upload';
